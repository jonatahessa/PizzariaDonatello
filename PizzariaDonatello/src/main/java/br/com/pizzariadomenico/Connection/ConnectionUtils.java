...
public class ConnectionUtils {
    ...
    public static java.sql.Connection getConnection() {
        ...
        try {
            ...
            String serveName = "donatello1.mysql.uhserver.com"; // Caminho do servidor do BD
            String mydatabase = "donatello1"; // Nome do banco de dados
            String url = "jdbc:mysql://" + serveName + "/" + mydatabase;
            String username = "dana01"; // Nome de usuario
